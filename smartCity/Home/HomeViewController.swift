...
class HomeViewController: UIViewController,SDCycleScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        _tableView.register(UINib.init(nibName: "HomeSecion1TableViewCell", bundle: Bundle.main), forCellReuseIdentifier: "HomeSecion1TableViewCell")
...
extension HomeViewController:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "HomeSecion1TableViewCell")
                as! HomeSecion1TableViewCell
            cell.superVC = self
            cell.selectionStyle = .none
            return cell
        }else{
