...
class FilterView: UIView,UITableViewDelegate,UITableViewDataSource {
    ...
    func InitView(){
        ...
        _tableView.register(UINib(nibName: "CheckTableViewCell", bundle: nil), forCellReuseIdentifier: "CheckTableViewCell")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        for i in 0..<datasource.count{
            let cell = tableView.cellForRow(at: IndexPath.init(row: i, section: 0)) as! CheckTableViewCell
            if i == indexPath.row{
