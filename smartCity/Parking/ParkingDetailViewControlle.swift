//
//  ParkingDetailViewControlle.swift
//  smartCity
//
...
class ParkingDetailViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        deserializeLocationJson(fileName: "站点详情数据") { (result) in
            ...
            datasource = [[(nil,""),(#imageLiteral(resourceName: "map_address"),(model.parkingAddress)),(#imageLiteral(resourceName: "map_Parkingspace"), "室内\(model.insideEmptyNo) | 室外\(model.outsideEmptyNo)"),(#imageLiteral(resourceName: "map_Charging_pile_N"),"快充\(model.fastChargeEmptyNo) | 慢充\(model.slowChargeEmptyNo)")],[("运 营 商",(model.parkingOperator)),("支付方式",(model.payWay)),("充电单价","未知"),("停 车 费","未知"),("车位数量","室内\(model.insideNo) 室外\(model.outsideNo)"),("电桩数量","快充 \(model.fastChargeNo) 慢充\(model.slowChargeNo)")]]
